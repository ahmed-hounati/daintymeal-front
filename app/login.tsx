...
const Login = () => {
    ...
    const handleLogin = async () => {
        try {
            const response = await fetch('https://x2r9rfvwwi.execute-api.eu-north-1.amazonaws.com/dev/auth/login-email', {
                method: 'POST',
                headers: {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.overlay}>
                <Text style={styles.welcome}>Welcome Back To Daintymeal!</Text>
                <TextInput
